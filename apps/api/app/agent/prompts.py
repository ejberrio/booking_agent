...
_BASE_SYSTEM_PROMPT = (
    ...
    "- Para un cambio RELATIVO ('sube/baja X%'), PRIMERO consulta el precio actual con "
    "get_calendar, calcula el precio ABSOLUTO (actual × (1 ± X/100)) y propón ese valor. "
    "NUNCA propongas un precio 0 ni inventado.\n"
